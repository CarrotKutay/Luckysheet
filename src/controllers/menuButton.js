...
const menuButton = {
    ...
    initialMenuButton: function () {
        ...
        $("#luckysheet-icon-border-all").click(function () {
            ...
            cfg["borderInfo"] = typeof cfg["borderInfo"] != "undefined"
            && cfg["borderInfo"] != null
            && (cfg["borderInfo"].length == null || cfg["borderInfo"].length === 0) ? [] : cfg["borderInfo"];
            console.log("info 1 >> ", cfg["borderInfo"])
            ...
            if ($menuButton.length == 0) {
                ...
                $menuButton.find(".luckysheet-cols-menuitem").click(function () {
                    ...
                    cfg["borderInfo"] = typeof cfg["borderInfo"] != "undefined"
                        && cfg["borderInfo"] != null
                        && (cfg["borderInfo"].length == null || cfg["borderInfo"].length === 0) ? [] : cfg["borderInfo"];
                    console.log("info >> 2", cfg["borderInfo"])
                    cfg["borderInfo"].push(borderInfo);
